##概要
本ソフウェアは、LibVLCを利用して作成した音楽再生ソフトウェアです。
...
###VLCのビルド
```bash
$ cd /libraries/vlc/vlc-3.0.22
$ tar Jxfv vlc_3.0.22.tar.xz
$ cd vlc_3.0.22/
$ ./bootstrap
$ ./configure
$ make
...
##ライセンス
GNU Public License 3.0の下でライセンスされています。

###使用したライブラリのライセンス  
- VLC -Copyright (C) 1998-2008 VLC authors and VideoLAN - LGPLv2.1 or later
VLCはGNU Lesser General Public License2.1の下でライセンスされています。  
VLCメディアプレーヤーのソースコードは、以下のリンクから入手できます：  
[UnixCompile](https://www.videolan.org/vlc/download-sources.html)
使用しているVLCのバージョン：3.0.22
...
[UnixCompile](https://github.com/libsdl-org/SDL/releases/)
使用しているSDL3のバージョン: 3.2.28

###VLCが利用しているライブラリのライセンス
